...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb back-transparente">
            ...
            <li class="breadcrumb-item active" aria-current="page">Editar Country</li>
        </ol>
    </nav> 

    <div class="card">
        <div class="card-header">Editar Country </div>
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('/country/' . $result->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                {{ csrf_field() }}
