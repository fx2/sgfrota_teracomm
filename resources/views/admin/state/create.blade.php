...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb back-transparente">
            ...
            <li class="breadcrumb-item active" aria-current="page">Cadastrar State</li>
        </ol>
    </nav> 

    <div class="card">
        <div class="card-header">Cadastrar State</div>
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('/state') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}

                @include ('admin.state.form', ['formMode' => 'create'])
