...
@section('content')
    ...
    <div class="card">
        <div class="card-header h3">Marca</div>
        <div class="card-body">
            <a href="{{ url('/marca/create') }}" class="btn btn-success btn-sm" title="Add New Marca">
...
{{--                            <td>{{ $loop->iteration }}</td>--}}
                            @foreach ($fields as $key => $val)
                                ...
                                @endforeach
                            <td>
                                {{-- <a href="{{ url('/marca/' . $item->id) }}" title="Visualizar Marca"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a> --}}
                                <a href="{{ url('/marca/' . $item->id . '/edit') }}" title="Editar Marca"><button class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></button></a>

                                <button type="submit" data-id="{{ $item->id }}" data-route="/marca" class="btnDeletar btn btn-danger btn-sm" title="Deletar Marca"><i class="fa fa-trash" aria-hidden="true"></i></button>
                            </td>
                        </tr>
                    @empty
                        <p class="p-1 hide-thead" onload="hideThead()">Nenhuma Marca encontrado</p>
                    @endforelse
                    </tbody>
                </table>
