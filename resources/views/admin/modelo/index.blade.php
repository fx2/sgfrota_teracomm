...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ url('/modelo/create') }}" class="btn btn-success btn-sm" title="Add New Modelo">
...
{{--                            <td>{{ $loop->iteration }}</td>--}}
                            @foreach ($fields as $key => $val)
                                ...
                                @endforeach
                            <td>
                                {{-- <a href="{{ url('/modelo/' . $item->id) }}" title="Visualizar Modelo"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a> --}}
                                <a href="{{ url('/modelo/' . $item->id . '/edit') }}" title="Editar Modelo"><button class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></button></a>
