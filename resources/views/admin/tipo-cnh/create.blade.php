...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb back-transparente">
            ...
            <li class="breadcrumb-item active" aria-current="page">Cadastrar Categoria CNH</li>
        </ol>
    </nav> 

    <div class="card">
        <div class="card-header">Cadastrar Categoria CNH</div>
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('/tipo-cnh') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}

                @include ('admin.tipo-cnh.form', ['formMode' => 'create'])
