...
@section('content')
    ...
    <div class="card">
        <div class="card-header h3">Users</div>
        <div class="card-body">
...
{{--                                <td>{{ $loop->iteration }}</td>--}}
                                ...
                                @endcan
                                    ...
                                    @endforeach
                                <td>
                                    {{-- <a href="{{ url('/users/' . $item->id) }}" title="Visualizar User"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a> --}}
{{--                                    @can('checksetor', _EDITAR)--}}
                                        <a href="{{ url('/users/' . $item->id . '/edit') }}" title="Editar User"><button class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></button></a>
{{--                                    @endcan--}}

{{--                                    @can('checksetor', _DELETAR)--}}
                                        <button type="submit" data-id="{{ $item->id }}" data-route="/users" class="btnDeletar btn btn-danger btn-sm" title="Deletar User"><i class="fa fa-trash" aria-hidden="true"></i></button>
{{--                                    @endcan--}}
                                </td>
                            </tr>
                        @empty
                            <p class="p-1 hide-thead" onload="hideThead()">Nenhum Users encontrado</p>
                        @endforelse
                    </tbody>
                </table>
